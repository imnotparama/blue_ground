...
const STAGES = [
  ...
  {
    stage: 5,
    title: '4-Stage RO Multi-Barrier',
    subtitle: 'Semi-Permeable Membrane Desalination',
    icon: Sliders,
    badge: 'STAGE 5/6',
    status: 'DEEP PURIFICATION',
    statusColor: 'text-teal-400 bg-teal-950/70 border-teal-500/40',
    description:
      'The 12V submersible pump boosts water pressure into the 4-stage housing (PP Sediment, CTO Carbon, 0.0001μm RO Membrane, Post-Mineralizer) to remove heavy metals and toxins.',
    metrics: [
  ...
  {
    stage: 6,
    title: 'Clean Storage & UV-C Disinfection',
    subtitle: '250L Potable Reservoir & Pathogen Inactivation',
    icon: Sparkles,
    badge: 'STAGE 6/6',
    status: 'READY TO DRINK',
    statusColor: 'text-emerald-400 bg-emerald-950/70 border-emerald-500/40',
    description:
      'Pure sparkling water cascades into the primary 250L storage tank. A 254nm germicidal UV-C emitter sterilizes bacteria while the magnetic float switch prevents overflow.',
    metrics: [
