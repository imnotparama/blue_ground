...
const componentCatalog: Record<string, ComponentDetail> = {
  ...
  filter_housing: {
    ...
    purpose: 'Engineered 4-stage sequential defense line designed for borewell, mining-slurry, and rural tank water to strip particles, chemicals, dissolved salts, and microbes.',
    principle: 'Combines Stage 1 SediShield (5µm sediment trap), Stage 2 ChemoBlock (activated carbon & chemical media), Stage 3 RO Maxx (0.0001µm high-pressure RO membrane), and Stage 4 FinalGuard UV (254nm germicidal disinfection) connected in series with thin glowing manifold conduits.',
    specifications: [
      ...
      'Stage 4 – FinalGuard UV (95% Health): 254nm UV-C kills microbes just before secondary tank & dispense',
    ],
    power: 'DC Pump Boost: 12V–24V / 24W | UV-C Emitter: 3.5W',
    maintenance: '91% Train Health • SediShield: 92% | ChemoBlock: 85% | RO Maxx: 88% | FinalGuard UV: 95%',
    processRole: 'The core multi-stage purification engine. Protects pumps, drops TDS into safe drinking/aquaculture bands, and neutralizes pathogens before storage.',
    getLiveReadout: (m) => `Train Status: NOMINAL | TDS Drop: ${m.tds || 680} → ${m.tds2 || 28} ppm (-96%) | UV-C: ${m.uvStatus}`,
  },
  filter: {
    ...
    principle: 'SediShield (sediment) ➔ ChemoBlock (chemical) ➔ RO Maxx (high-pressure RO) ➔ FinalGuard UV (germicidal).',
    specifications: [
      'Stage 1 – SediShield: Blocks dirt, silt & rust (92%)',
      'Stage 2 – ChemoBlock: Cuts chlorine & odour (85%)',
      'Stage 3 – RO Maxx: Drops TDS & metals (88%)',
      'Stage 4 – FinalGuard UV: Kills microbes before dispense (95%)',
    ],
    power: 'Active load: 24W + 3.5W UV',
    maintenance: 'Health: 91% • All 4 cartridges online',
    processRole: 'Primary borewell and mining purification stack.',
    getLiveReadout: (m) => `Filter Train: Active | SediShield: 92% | ChemoBlock: 85% | RO Maxx: 88% | FinalGuard UV: 95%`,
  },
  primary_tank: {
