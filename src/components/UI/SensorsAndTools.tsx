...
export const TOOLS_CATALOG: ToolItem[] = [
  ...
  },
  {
    ...
    category: 'VESSELS',
    model: 'SediShield + ChemoBlock + RO Maxx + FinalGuard UV',
    spec: 'Borewell & Mining Defense • Particles, Chemicals, Salts, Microbes',
    location: 'Back-Mounted Filtration Rack (x = -0.70, z = -0.62)',
    getLiveValue: (m) => `Health: 91% (Sedi: ${m.stage1Health || 92}%, Chemo: ${m.stage2Health || 85}%, RO: ${m.stage3Health || 88}%, UV: ${m.stage4Health || 95}%)`,
